...
btnCatProcesadoresAmd.addEventListener("click", () => {
    filtrarPorCategoria("Procesadores AMD", "procesadores-amd", "Procesadores AMD");
});

btnCatProcesadoresIntel.addEventListener("click", () => {
    filtrarPorCategoria("Procesadores Intel", "procesadores-intel", "Procesadores Intel");
});

btnCatMothersAmd.addEventListener("click", () => {
    filtrarPorCategoria("Motherboards AMD", "motherboards-amd", "Motherboards AMD");
});

btnCatMothersIntel.addEventListener("click", () => {
    filtrarPorCategoria("Motherboards Intel", "motherboards-intel", "Motherboards Intel");
});

btnCatPlacasGeforce.addEventListener("click", ()=> {
    filtrarPorCategoria("Placas de video Geforce", "placas-de-video-gforce", "Placas de video Geforce");
});

btnCatPlacasAmd.addEventListener("click", () => {
    filtrarPorCategoria("Placas de video Radeon AMD", "placas-de-video-radeon-amd", "Placas de video Radeon AMD");
});
...
btnCatMemoriasNotebook.addEventListener("click", () => {
    filtrarPorCategoria("Memorias notebook", "memorias-notebook", "Memorias notebook");
});

btnCatMonitores.addEventListener("click", () => {
    filtrarPorCategoria("Monitores", "monitores", "Monitores");
});
